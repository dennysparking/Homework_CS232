#include "crawler.h"
 ...
 //returns 1 if the list starting at pNode contains the address addr, and returns 0 otherwise
...
int contains(const struct listNode *pNode, const char *addr)
{
  ...
  if (pNode == NULL)
  {
    return 0; //If no node has been found to contain the address, return 0.
  }
  else
  {
